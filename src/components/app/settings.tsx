...
const SettingsScreen = () => {
  ...
  const iconList = Object.keys(iconData).map((iconName) => ({
    Icon: {
      name: iconName,
      size: 30,
      color: 'blue',
  ...
  return (
       <ScrollView style={{ flexDirection: 'row', flexWrap: 'wrap-reverse' }}>
    {Object.keys(iconData).map((iconName) => (
      <Icon
        ...
        size={30}
        color="blue"
        style={{ margin: 5, width: 30, height: 30 }}  // Ajuste o tamanho do ícone conforme necessário
      />
    ))}
  </ScrollView>
